...
public final class SystemUtils {
    ...
    public static String getCurProcessName(Context context) {
        ...
        java.util.List<ActivityManager.RunningAppProcessInfo> runningAppProcessInfos = mActivityManager.getRunningAppProcesses();
    ...
    public static CommandResult exec(boolean isRoot, java.util.List<String> commands) {
